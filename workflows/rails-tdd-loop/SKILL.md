...
1. **context/rails-context-engineering**: Load schema, routes, and patterns.
2. **testing/rails-tdd-slices**: Choose the best first failing spec.
3. **testing/rspec-best-practices**: Write test and verify failure.

**HARD GATE — Test Feedback:**
- Test EXISTS and is RUN.
- FAILS for correct reason (e.g., `undefined method 'full_name'`).
- If FAIL is incorrect (syntax, config), return to `rspec-best-practices`.
...
2. **patterns/yard-documentation**: Document public Ruby API.
3. **code-quality/rails-code-review**: Self-review PR diff.
